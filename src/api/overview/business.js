...
function useOverviewActions() {
  ...
  return {
    ...
    getBusinesses: (businessTypeId) =>
      commonUtil.generatePromiseGet(baseUrl + `business/list/${businessTypeId}`),
    getBusinessType: () => commonUtil.generatePromiseGet(baseUrl + 'businessType/list'),
    getDurationList: () =>
      commonUtil.generatePromiseGet(baseUrl + `duration/list?t=${new Date().getTime()}`),
    ...
    getCloudTypes: (params) => commonUtil.generatePromiseGet(baseUrl + `getCloudType`, params),
    getResourceTypes: (params) =>
      commonUtil.generatePromiseGet(baseUrl + `getResourceType`, params),
    getResources: (params) => commonUtil.generatePromiseGet(baseUrl + `getResources`, params),
    getAccessTypes: (businessId) =>
      commonUtil.generatePromiseGet(
        baseUrl + `getNetworkAccessType/${businessId}?t=${new Date().getTime()}`
      ),
    ...
    getVmInstance: (businessId, cloudType) =>
      commonUtil.generatePromiseGet(baseUrl + `business/vm/${businessId}?cloudType=${cloudType}`),
    getVmQuota: (param) =>
      commonUtil.generatePromisePost(
        baseUrl + `business/cloudResource/vmQuota?t=${new Date().getTime()}`,
        param
      ),
    getP2pConnectStat: (businessId) =>
      commonUtil.generatePromiseGet(baseUrl + `queryNetwork/${businessId}`),

    getMetricList: (param) =>
      commonUtil.generatePromiseGet(baseUrl + `cloud/metricName/list`, param),
    getMonitorMetric: (param) => commonUtil.generatePromisePost(baseUrl + `cloud/metric`, param),
    getMonitorFunMetric: (param) =>
      commonUtil.generatePromisePost(baseUrl + `cloud/function/metric`, param)
  }
}
