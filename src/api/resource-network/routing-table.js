...
const baseUrl = '/api/resource/route'
...
const subnetUnbind = (param) => commonUtil.generatePromisePost(baseUrl + `/unbind`, param)
...
const routeEntryDelete = (param) => commonUtil.generatePromisePost(baseUrl + '/entry/delete', param)
